...
public class ProgWidgetItemCondition extends ProgWidgetConditionBase{
    ...
    public boolean evaluate(IDroneBase drone, IProgWidget widget){
        ...
        while(checkedFilter != null) {
            if(!ProgWidgetItemFilter.isItemValidForFilters(checkedFilter.getFilter(), ProgWidget.getConnectedWidgetList(this, 1), ProgWidget.getConnectedWidgetList(this, getParameters().length + 1), null)) return false;
